...
|---|---|---|
| `adversarial-validation` | Research-grounded falsification, robustness, or red-team review is needed | one standalone skill with research and playbook references |
