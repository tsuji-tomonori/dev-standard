...
| `AZURE-AI-WAF` | Microsoft | [AI Workload Documentation - Azure Well-Architected Framework](https://learn.microsoft.com/en-us/azure/wellarchitected/ai/) | 継続更新 | 非決定的挙動、データ、モデル、AIアプリケーション、AI運用を含むAzure AIワークロード。 | 2026-07-18 | 2026-07-18 | 90日 | AI-CONDITIONAL, AZURE-DELTA | — |
