...
| `DEVSTD-AS-BUILT` | dev-standard maintainers | [as-built設計標準](https://github.com/tsuji-tomonori/dev-standard/blob/main/docs/standards/AS-BUILT-DESIGN.md) | 2026-08-29 | 実装由来設計の決定論的生成、専用path、整合check、解析可能な実装・test規約。標準contract変更とrepository採用scopeを分離し、関係するcheckだけを選択する。 | 2026-08-29 | 2026-08-29 | 180日 | CORE | `1b8be6f5122715b6b8b5934aba7abc91a11f09e29164a01eb9c0f022240b0ffe` |
