...
既定profileが配布するガードレールは次の3本だけとする。
...
6. default profileが3本柱と会話entry pointだけであることを確認する。
...
- default profileは会話entry pointと3本柱だけを含む。
- どのprofileも導入先のCI、branch、merge設定へ触れない。
