...
class SpecflowTest(unittest.TestCase):
    def test_self_hosted_catalog_is_valid_and_generated_view_is_current(self) -> None:
        ...
        self.assertEqual(len(catalog["requirements"]), 53)
